...
| Harish | 1992-06-04, 03:10 AM IST, Pallipattu (Tiruvallur), Tamil Nadu — 13.33°N, 79.45°E | 辛 신 (Yin Metal) | Water (水) *(engine heuristic, 조후 climate-check applied)* | [harish/harish-report.md](reports/harish/harish-report.md) + [PDF](reports/harish/harish-report.pdf) — Deep Destiny (engine `--tier deep`, `--longitude 79.4408 --city "Pallipattu, Tamil Nadu"`, no override), **regenerated from scratch 2026-09-14** after fixing a `premium_report.py` bug where the "What This Year Means for You" callout read the raw un-resolved favorable element instead of the resolved one — this report now shows Water/Metal natively, with no hand-patching. Pillars re-validated (壬申/乙巳/辛亥/己丑). ⚠️ **The candidate folder was cleared for this regen and the three follow-ups are not yet recreated:** career.md, land-workshop-business.md (+ PDF), and luck-timeline.md (+ PDF) — these need a dedicated re-authoring pass onto Water/희신=Metal/기신=Earth/avoid=Fire (not a mechanical regen), flagged 2026-09-13/14, not yet done. |
...
| Mahesh | 1995-01-19, 11:50 PM IST, Ambur TN | 庚 경 (Yang Metal) | Earth (土) | [mahesh/mahesh-report.md](reports/mahesh/mahesh-report.md) + [career.md](reports/mahesh/career.md) + [relationships.md](reports/mahesh/relationships.md) — PDFs: [base](reports/mahesh/mahesh-report.pdf) · [combined](reports/mahesh/mahesh-combined.pdf) · [combined-html](reports/mahesh/mahesh-combined-html.pdf) |
