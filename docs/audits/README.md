...
| `2026-09-26-deep-engine-audit.md` | 2026-09-26 | Fresh deep audit after E-1…E-13 closed: calculation, 절기 data (ephemeris cross-check, `scripts/check_solar_terms.py`), strength/용신 doctrine, stars/grids, compat, web tools, CI | 11 of 22 findings FIXED, 3 PARTIAL, 3 doctrinal decisions recorded (2 pending implementation), 5 not started, 1 not actionable in this repo — see `2026-09-26-deep-engine-audit-verification.md` for the live tracker. |
| `2026-09-26-deep-engine-audit-verification.md` | 2026-09-26 | Fix tracker for the audit above — per-finding status, fix log with commit hashes, and the three doctrinal decisions (N-5, N-6, N-9) recorded against the actual knowledge-file text | Live — update as remaining findings are fixed. |
