...
| `2026-09-26-deep-engine-audit.md` | 2026-09-26 | Fresh deep audit after E-1…E-13 closed: calculation, 절기 data (ephemeris cross-check, `scripts/check_solar_terms.py`), strength/용신 doctrine, stars/grids, compat, web tools, CI | **Open** — 22 findings (N-1 P0, N-2…N-8 P1). See its §4 for fix order. |
