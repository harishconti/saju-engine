...
Korean and Hanja terminology used throughout the Saju knowledge base. Entries are listed alphabetically by the English convention (Hanja / 한글 / romanization → definition).

> **Convention used in all knowledge files**
>
> - 천간 (cheongan) = Heavenly Stem
> - 지지 (jiji) = Earthly Branch
> - 간지 (ganji) = Stem-Branch pair
> - 사주 (saju) = Four Pillars
> - 명식 (myeongsik) = the natal chart
> - 일간 (ilgan) = Day Master
> - 일주 (ilju) = Day Pillar
> - 용신 (yongsin) = Favorable Element
> - 희신 (huisin) = Supporting Element (helpful to 용신)
> - 기신 (gisin) = Unfavorable Element
> - 구신 (gusin) = Restricting Element (restrains 용신)
> - 한신 (hansin) = Draining Element (drains 용신)
> - 격국 (gyeokguk) = Chart structure / formation
> - 신살 (shinsal) = Spirit / star (special formation)
> - 십신 (sipsin) = Ten Gods
> - 대운 (daeun) = Major Luck Period
> - 세운 (seun) = Annual Luck
> - 공망 (gongmang) = Void / Empty (in a sixty-pillar cycle)
> - 12운성 (sibiunseong) = Twelve Life Stages
> - 12신살 (sibishinsal) = Twelve Spirits
...
- **대운 (daeun, 大運)** — Major Luck Period. Roughly decade-long cycles that follow the natal chart. Direction (forward / reverse) is determined by yin/yang of the year stem and gender of the querent.
- **도화살 (Dohwa-sal, 桃花殺)** — "Peach Blossom Star." A 신살 associated with charm, attractiveness, romantic magnetism, and sometimes scandal.
- **도화 (Dohwa)** — see 도화살.
...
- **인성 (inseong, 印星)** — Resource / Seal. Ten God class. See 십신.
- **인성격 (inseong gyeokguk, 印格)** — Resource Grid. The strongest stem in the month is the Day Master's 인성. Day Master is typically strong, with 인성 further strengthening it.
...
- **명리 (Myeongri, 命理)** — "The principles of destiny." Korean term for the broader Saju / Four Pillars discipline.
- **명리학 (Myeongrihak, 命理學)** — Same as 명리.
- **명식 (Myeongsik, 命式)** — The natal chart, written out.
- **묘 (myo, 卯)** — Yin Wood branch. Rabbit.
...
- **오행 (ohaeng, 五行)** — Five Elements: 木 Wood, 火 Fire, 土 Earth, 金 Metal, 水 Water.
...
- **양 (yang, 陽)** — Yang. Bright, active, outward, ascending, masculine. See 음양.
...
- **유 (yu, 酉)** — Yin Metal branch. Rooster.
- **육합 (yukhap, 六合)** — Six Combinations. Branch pairs that combine: 子丑, 寅亥, 卯戌, 辰酉, 巳申, 午未.
- **음 (eum, 陰)** — Yin. Dark, receptive, inward, descending, feminine. See 음양.
- **음양 (eumyang, 陰陽)** — Yin and Yang. The two primordial polarities.
- **인 (in, 寅)** — Yang Wood branch. Tiger.
- **인성 (inseong, 印星)** — Resource. Ten God class. See 십신.

## Z

- **자 (ja, 子)** — Yang Water branch. Rat.
- **자형 (jahyeong, 自刑)** — Self-punishment. See under J.
- **장생 (jangsaeng, 長生)** — Birth / Long Life. The first of the 12운성.
- **재고 (jaego, 財庫)** — Wealth storehouse. The 재성 element sitting as the qi of one of the four stored branches (辰戌丑未); wealth read as accumulated / latent, traditionally "opening" on a 충 or 형. See `knowledge/13-wealth-and-business.md`.
...
## Quick lookup: Hanja → Korean → meaning

| Hanja | Korean | Romanization | English |
|---|---|---|---|
| 子 | 자 | ja | Rat (Yang Water branch) |
| 丑 | 축 | chuk | Ox (Yin Earth branch) |
| 寅 | 인 | in | Tiger (Yang Wood branch) |
| 卯 | 묘 | myo | Rabbit (Yin Wood branch) |
| 辰 | 진 | jin | Dragon (Yang Earth branch) |
| 巳 | 사 | sa | Snake (Yin Fire branch) |
| 午 | 오 | o | Horse (Yang Fire branch) |
| 未 | 미 | mi | Goat (Yin Earth branch) |
| 申 | 신 | shin | Monkey (Yang Metal branch) |
| 酉 | 유 | yu | Rooster (Yin Metal branch) |
| 戌 | 술 | sul | Dog (Yang Earth branch) |
| 亥 | 해 | hae | Pig (Yin Water branch) |
| 甲 | 갑 | gap | Yang Wood stem |
| 乙 | 을 | eul | Yin Wood stem |
| 丙 | 병 | byeong | Yang Fire stem |
| 丁 | 정 | jeong | Yin Fire stem |
| 戊 | 무 | mu | Yang Earth stem |
| 己 | 기 | gi | Yin Earth stem |
| 庚 | 경 | gyeong | Yang Metal stem |
| 辛 | 신 | sin | Yin Metal stem |
